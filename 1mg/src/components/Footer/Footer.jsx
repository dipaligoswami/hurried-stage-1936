...
export const Footer = () => {
    ...
    return <div id="shadow1">
        ...
        <div class="footerDabba">
            <div class="topbar">

                <div class="tophead">
                    <h2 id="nav_heading">INDIA’S LARGEST HEALTHCARE PLATFORM</h2>
                </div>
                ...
                <div id="box">
                    <div>
                        <div id="box1">
                            160m+</div>
                        <div id="text">Visitors</div>
                    </div>
                    <div>
                        <div id="box1">27m+</div>
                        <div id="text">Orders Delivered</div>
                    </div>
                    <div>
                        <div id="box1">1800+</div>
                        <div id="text">Cities</div>
                    </div>
                </div>
            </div>
            ...
            <div id="box5">
                ...
                <div >
                    <p id="getapp">Get the link to download App</p>
                </div>

                <div>
                    <form>
                        <input type="tel" placeholder="Enter Phone Number" class="text" maxlength="10" autocomplete="off" valuepattern="[6-9]\d{9}" required />
                        <button type="submit" id="butn">Send Link</button>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div id="container">
                <div id="uppercontainer">
                    <div>
                        ...
                        <p className="msg">Press Coverage</p>
                        <p className="msg">Careers</p>
                        <p className="msg">Business Partnership</p>
                        <p className="msg">Become a Health Partner</p>
                    </div>

                    <div>
                        <h3>Our Policies</h3>
                        <p className="msg">Privacy Policy</p>
                        <p className="msg">Terms and Conditions</p>
                        <p className="msg">Editorial Policy</p>
                        <p className="msg">Return Policy</p>
                        <p className="msg">IP Policy</p>
                        <p className="msg">Grievance Redressal Policy</p>
                    </div>
                    ...
                    <div id="connect" >
                        <h3>Connect</h3>
                        <div><p className="msg">social link</p></div>
                        <div id="logo1">
                            ...
                            <div id="medium"> <a href="https://medium.com/1mgofficial"><img src="	https://res.cloudinary.com/du8msdgbj/image/upload/v1601285810/marketing/jf3bry3wl6zzkd14yces.svg" height="30px" alt="" /></a></div>
                        </div>
                        <div><p className="msg">Want daily dose of health?</p></div>
                    ...
                    <div id="app">
                        ...
                        <div class="logo2">
                            ...
                            <a href="https://play.google.com/store/apps/details?id=com.aranoah.healthkart.plus">
                                ...
                                <img src="https://www.freepnglogos.com/uploads/app-store-logo-png/apple-app-store-travel-awards-globestamp-7.png" width="160px" height="100px" alt="" /></a>
                ...
                <div id="secondbox">
                    <div class="box1">
                        ...
                        <div class="bigbox"><h2> Reliable</h2>
                            <p class="msg" > All products displayed on Tata 1mg are procured from verified and licensed pharmacies. All labs listed on the platform are accredited </p>
                        </div>
                    </div>
                    <div class="box1">
                ...
                <div id="thirdbox">
                    ...
                    <div class="logo3">
                        <div class="img1"><a href="http://legitscript.com" target="_blank" title="Verify LegitScript Approval"><img src="https://static.legitscript.com/seals/729605.png" alt="LegitScript approved" width="130" height="90" /></a></div>
                        <div class="img2"><img src="https://res.cloudinary.com/du8msdgbj/image/upload/v1580717209/URS_ebgmxc.png" width="110px" height="100px" alt="" /></div>
